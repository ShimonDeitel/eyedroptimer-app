import XCTest
@testable import EyeDropTimer

@MainActor
final class EyeDropTimerTests: XCTestCase {
    ...
    func testUpdateReplacesItem() {
        ...
        first.prescriptionName = "Updated Name"
        store.update(first)
        XCTAssertEqual(store.items.first?.prescriptionName, "Updated Name")
    }
